...
const {DAI, DAI_WHALE, POOL_ADDRESS_PROVIDER} = require("../Addresses/Addresses.js");
...
describe("Deploy a Flash Loan", function () {
  it("Should take a flash loan and be able to return it", async function () {
    ...
    const esti = await _flashLoanExample.estimateGas.createFlashLoan(DAI, 1000);
    console.log("estimate gas", esti);
